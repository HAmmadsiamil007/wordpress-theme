			...
			array(
				...
				'attributes'      => array(
					...
					'features'    => array(
						...
						'default' => array(
							array(
								'text'     => esc_html__( 'Feature 1', 'opulentia' ),
								'included' => true,
							),
							array(
								'text'     => esc_html__( 'Feature 2', 'opulentia' ),
								'included' => true,
							),
							array(
								'text'     => esc_html__( 'Feature 3', 'opulentia' ),
								'included' => false,
							),
							array(
								'text'     => esc_html__( 'Feature 4', 'opulentia' ),
								'included' => false,
							),
						),
						'items'   => array(
