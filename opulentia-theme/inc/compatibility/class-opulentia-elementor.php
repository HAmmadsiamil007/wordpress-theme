...
class Opulentia_Elementor {
	...
	public function register_widgets( $widgets_manager ) {
		...
		$widgets_manager->register(
			new class( $this ) extends \Elementor\Widget_Base {
				...
				protected function register_controls() {
					...
					$this->add_control(
						...
						array(
							...
							'default'     => array(
								array(
									'feature_text' => esc_html__( 'Feature 1', 'opulentia' ),
									'included'     => 'yes',
								),
								array(
									'feature_text' => esc_html__( 'Feature 2', 'opulentia' ),
									'included'     => 'yes',
								),
							),
				...
				protected function register_controls() {
					...
					$this->add_control(
						...
						array(
							...
							'default'     => array(
								array(
									'tab_title'   => esc_html__( 'Tab 1', 'opulentia' ),
									'tab_content' => esc_html__( 'Content 1', 'opulentia' ),
								),
								array(
									'tab_title'   => esc_html__( 'Tab 2', 'opulentia' ),
									'tab_content' => esc_html__( 'Content 2', 'opulentia' ),
								),
								array(
									'tab_title'   => esc_html__( 'Tab 3', 'opulentia' ),
									'tab_content' => esc_html__( 'Content 3', 'opulentia' ),
								),
							),
