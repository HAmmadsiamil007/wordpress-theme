...
class Opulentia_Elementor_Pro {
	...
	public function sync_global_colors() {
		...
		$palette_map = array(
			0 => array(
				'id'    => 'opulentia-palette-0',
				'title' => __( 'Page Background', 'opulentia' ),
			),
			1 => array(
				'id'    => 'opulentia-palette-1',
				'title' => __( 'Section Background', 'opulentia' ),
			),
			2 => array(
				'id'    => 'opulentia-palette-2',
				'title' => __( 'Accent', 'opulentia' ),
			),
			3 => array(
				'id'    => 'opulentia-palette-3',
				'title' => __( 'Gold / Headings', 'opulentia' ),
			),
			4 => array(
				'id'    => 'opulentia-palette-4',
				'title' => __( 'Light Gold', 'opulentia' ),
			),
			5 => array(
				'id'    => 'opulentia-palette-5',
				'title' => __( 'Body Text', 'opulentia' ),
			),
			6 => array(
				'id'    => 'opulentia-palette-6',
				'title' => __( 'Muted Text', 'opulentia' ),
			),
			7 => array(
				'id'    => 'opulentia-palette-7',
				'title' => __( 'Border', 'opulentia' ),
			),
			8 => array(
				'id'    => 'opulentia-palette-8',
				'title' => __( 'White / Bright', 'opulentia' ),
			),
		);
