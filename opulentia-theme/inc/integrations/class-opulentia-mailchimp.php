...
class Opulentia_Mailchimp {
    ...
    public function register_settings() {
        ...
        register_setting( self::SETTINGS_PAGE, self::OPTION_API_KEY, array(
            'type'              => 'string',
        ...
        register_setting( self::SETTINGS_PAGE, self::OPTION_LIST_ID, array(
            'type'              => 'string',
            'sanitize_callback' => 'sanitize_text_field',
            'default'           => '',
        ) );
        ...
        register_setting( self::SETTINGS_PAGE, self::OPTION_DOUBLE_OPTIN, array(
            'type'              => 'boolean',
    ...
    public function ping() {
        ...
        return new \WP_Error(
            ...
            sprintf(
                ...
                __( 'API returned HTTP %d: %s', 'opulentia' ),
                $status_code,
                $detail
            )
        );
