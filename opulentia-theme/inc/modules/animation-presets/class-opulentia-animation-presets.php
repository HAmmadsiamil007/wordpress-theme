...
class Opulentia_Animation_Presets {
    ...
    public function customize_register( $wp_customize ) {
        $wp_customize->add_panel( 'opulentia_animations', array(
        ...
        // ── Global Toggle ──
        $wp_customize->add_section( 'op_anim_global', array(
            'title'       => __( 'Global Settings', 'opulentia' ),
            'panel'       => 'opulentia_animations',
            'priority'    => 1,
        ) );

        $wp_customize->add_setting( 'op_animations_enable', array(
            'default'           => true,
            'sanitize_callback' => 'wp_validate_boolean',
            'transport'         => 'refresh',
        ) );

        $wp_customize->add_control( 'op_animations_enable', array(
        ...
        $wp_customize->add_setting( 'op_anim_ease', array(
            'default'           => 'power3.out',
            'sanitize_callback' => 'sanitize_text_field',
            'transport'         => 'refresh',
        ) );

        $wp_customize->add_control( 'op_anim_ease', array(
        ...
        $wp_customize->add_setting( 'op_anim_duration', array(
            'default'           => 1,
            'sanitize_callback' => 'absint',
            'transport'         => 'refresh',
        ) );

        $wp_customize->add_control( 'op_anim_duration', array(
        ...
        // ── Scroll Reveal ──
        $wp_customize->add_section( 'op_anim_scroll_reveal', array(
            'title'       => __( 'Scroll Reveal', 'opulentia' ),
            'panel'       => 'opulentia_animations',
            'priority'    => 10,
        ) );

        $wp_customize->add_setting( 'op_anim_reveal_enable', array(
            'default'           => true,
            'sanitize_callback' => 'wp_validate_boolean',
            'transport'         => 'refresh',
        ) );

        $wp_customize->add_control( 'op_anim_reveal_enable', array(
            'label'   => __( 'Enable Scroll Reveal', 'opulentia' ),
            'section' => 'op_anim_scroll_reveal',
            'type'    => 'checkbox',
        ) );

        $wp_customize->add_setting( 'op_anim_reveal_effect', array(
            'default'           => 'fade',
            'sanitize_callback' => 'sanitize_text_field',
            'transport'         => 'refresh',
        ) );

        $wp_customize->add_control( 'op_anim_reveal_effect', array(
        ...
        $wp_customize->add_setting( 'op_anim_reveal_direction', array(
            'default'           => 'up',
            'sanitize_callback' => 'sanitize_text_field',
            'transport'         => 'refresh',
        ) );

        $wp_customize->add_control( 'op_anim_reveal_direction', array(
        ...
        $wp_customize->add_setting( 'op_anim_reveal_distance', array(
            'default'           => 50,
            'sanitize_callback' => 'absint',
            'transport'         => 'refresh',
        ) );

        $wp_customize->add_control( 'op_anim_reveal_distance', array(
        ...
        $wp_customize->add_setting( 'op_anim_reveal_duration', array(
            'default'           => 0.8,
            'sanitize_callback' => 'sanitize_text_field',
            'transport'         => 'refresh',
        ) );

        $wp_customize->add_control( 'op_anim_reveal_duration', array(
        ...
        $wp_customize->add_setting( 'op_anim_reveal_delay', array(
            'default'           => 0,
            'sanitize_callback' => 'sanitize_text_field',
            'transport'         => 'refresh',
        ) );

        $wp_customize->add_control( 'op_anim_reveal_delay', array(
        ...
        $wp_customize->add_setting( 'op_anim_reveal_trigger', array(
            'default'           => 'top 85%',
            'sanitize_callback' => 'sanitize_text_field',
            'transport'         => 'refresh',
        ) );

        $wp_customize->add_control( 'op_anim_reveal_trigger', array(
        ...
        // ── Parallax ──
        $wp_customize->add_section( 'op_anim_parallax', array(
            'title'       => __( 'Parallax', 'opulentia' ),
            'panel'       => 'opulentia_animations',
            'priority'    => 20,
        ) );

        $wp_customize->add_setting( 'op_anim_parallax_enable', array(
            'default'           => true,
            'sanitize_callback' => 'wp_validate_boolean',
            'transport'         => 'refresh',
        ) );

        $wp_customize->add_control( 'op_anim_parallax_enable', array(
            'label'   => __( 'Enable Parallax', 'opulentia' ),
            'section' => 'op_anim_parallax',
            'type'    => 'checkbox',
        ) );

        $wp_customize->add_setting( 'op_anim_parallax_speed', array(
            'default'           => 0.5,
            'sanitize_callback' => 'sanitize_text_field',
            'transport'         => 'refresh',
        ) );

        $wp_customize->add_control( 'op_anim_parallax_speed', array(
        ...
        $wp_customize->add_setting( 'op_anim_parallax_direction', array(
            'default'           => 'up',
            'sanitize_callback' => 'sanitize_text_field',
            'transport'         => 'refresh',
        ) );

        $wp_customize->add_control( 'op_anim_parallax_direction', array(
        ...
        // ── Stagger ──
        $wp_customize->add_section( 'op_anim_stagger', array(
            'title'       => __( 'Stagger', 'opulentia' ),
            'panel'       => 'opulentia_animations',
            'priority'    => 30,
        ) );

        $wp_customize->add_setting( 'op_anim_stagger_enable', array(
            'default'           => true,
            'sanitize_callback' => 'wp_validate_boolean',
            'transport'         => 'refresh',
        ) );

        $wp_customize->add_control( 'op_anim_stagger_enable', array(
            'label'   => __( 'Enable Stagger', 'opulentia' ),
            'section' => 'op_anim_stagger',
            'type'    => 'checkbox',
        ) );

        $wp_customize->add_setting( 'op_anim_stagger_delay', array(
            'default'           => 0.1,
            'sanitize_callback' => 'sanitize_text_field',
            'transport'         => 'refresh',
        ) );

        $wp_customize->add_control( 'op_anim_stagger_delay', array(
        ...
        $wp_customize->add_setting( 'op_anim_stagger_axis', array(
            'default'           => 'y',
            'sanitize_callback' => 'sanitize_text_field',
            'transport'         => 'refresh',
        ) );

        $wp_customize->add_control( 'op_anim_stagger_axis', array(
        ...
        // ── Counter ──
        $wp_customize->add_section( 'op_anim_counter', array(
            'title'       => __( 'Counter Animation', 'opulentia' ),
            'panel'       => 'opulentia_animations',
            'priority'    => 40,
        ) );

        $wp_customize->add_setting( 'op_anim_counter_enable', array(
            'default'           => true,
            'sanitize_callback' => 'wp_validate_boolean',
            'transport'         => 'refresh',
        ) );

        $wp_customize->add_control( 'op_anim_counter_enable', array(
            'label'   => __( 'Enable Counter Animation', 'opulentia' ),
            'section' => 'op_anim_counter',
            'type'    => 'checkbox',
        ) );

        $wp_customize->add_setting( 'op_anim_counter_duration', array(
            'default'           => 2000,
            'sanitize_callback' => 'absint',
            'transport'         => 'refresh',
        ) );

        $wp_customize->add_control( 'op_anim_counter_duration', array(
        ...
        // ── Text Split ──
        $wp_customize->add_section( 'op_anim_text', array(
            'title'       => __( 'Text Split', 'opulentia' ),
            'panel'       => 'opulentia_animations',
            'priority'    => 50,
        ) );

        $wp_customize->add_setting( 'op_anim_text_enable', array(
            'default'           => true,
            'sanitize_callback' => 'wp_validate_boolean',
            'transport'         => 'refresh',
        ) );

        $wp_customize->add_control( 'op_anim_text_enable', array(
            'label'   => __( 'Enable Text Split', 'opulentia' ),
            'section' => 'op_anim_text',
            'type'    => 'checkbox',
        ) );

        $wp_customize->add_setting( 'op_anim_text_type', array(
            'default'           => 'words',
            'sanitize_callback' => 'sanitize_text_field',
            'transport'         => 'refresh',
        ) );

        $wp_customize->add_control( 'op_anim_text_type', array(
    ...
    public function enqueue_scripts() {
        ...
        wp_localize_script( 'opulentia-animations', 'OpulentiaAnim', array(
            'reveal'   => array(
