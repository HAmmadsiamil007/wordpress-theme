...
class Opulentia_Advanced_Typography {
    ...
    public function register_customizer( $wp_customize ) {
        $wp_customize->add_section( 'opulentia_advanced_typography', array(
        ...
        foreach ( $this->elements as $el => $el_label ) {
            $wp_customize->add_setting( 'typo_' . $el . '_heading', array(
                'sanitize_callback' => 'sanitize_text_field',
            ) );
            $wp_customize->add_control( 'typo_' . $el . '_heading', array(
                'label'   => $el_label,
            ...
            foreach ( $this->devices as $device ) {
                ...
                $wp_customize->add_setting( 'typo_' . $el . '_' . $device . '_font_family', array(
                    'default'           => '',
                    'sanitize_callback' => 'sanitize_text_field',
                    'transport'         => 'refresh',
                ) );
                $wp_customize->add_control( 'typo_' . $el . '_' . $device . '_font_family', array(
                ...
                $wp_customize->add_setting( 'typo_' . $el . '_' . $device . '_font_weight', array(
                    'default'           => '',
                    'sanitize_callback' => 'sanitize_text_field',
                    'transport'         => 'refresh',
                ) );
                $wp_customize->add_control( 'typo_' . $el . '_' . $device . '_font_weight', array(
                ...
                $wp_customize->add_setting( 'typo_' . $el . '_' . $device . '_font_size', array(
                    'default'           => '',
                    'sanitize_callback' => 'sanitize_text_field',
                    'transport'         => 'refresh',
                ) );
                $wp_customize->add_control( 'typo_' . $el . '_' . $device . '_font_size', array(
                ...
                $wp_customize->add_setting( 'typo_' . $el . '_' . $device . '_line_height', array(
                    'default'           => '',
                    'sanitize_callback' => 'sanitize_text_field',
                    'transport'         => 'refresh',
                ) );
                $wp_customize->add_control( 'typo_' . $el . '_' . $device . '_line_height', array(
                ...
                $wp_customize->add_setting( 'typo_' . $el . '_' . $device . '_letter_spacing', array(
                    'default'           => '',
                    'sanitize_callback' => 'sanitize_text_field',
                    'transport'         => 'refresh',
                ) );
                $wp_customize->add_control( 'typo_' . $el . '_' . $device . '_letter_spacing', array(
                ...
                $wp_customize->add_setting( 'typo_' . $el . '_' . $device . '_text_transform', array(
                    'default'           => '',
                    'sanitize_callback' => 'sanitize_text_field',
                    'transport'         => 'refresh',
                ) );
                $wp_customize->add_control( 'typo_' . $el . '_' . $device . '_text_transform', array(
