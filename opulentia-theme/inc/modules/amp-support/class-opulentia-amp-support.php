...
class Opulentia_AMP_Support {
    ...
    public function register_customizer( $wp_customize ) {
        $wp_customize->add_section( 'opulentia_amp', array(
        ...
        $wp_customize->add_control( new WP_Customize_Image_Control( $wp_customize, 'amp-logo', array(
        ...
        $wp_customize->add_setting( 'amp-header-bg', array(
            'default'           => 'var(--color-primary-dark)',
            'sanitize_callback' => 'sanitize_text_field',
            'transport'         => 'postMessage',
        ) );
        $wp_customize->add_control( 'amp-header-bg', array(
        ...
        $wp_customize->add_setting( 'amp-enable-sidebar', array(
            'default'           => true,
            'sanitize_callback' => 'wp_validate_boolean',
            'transport'         => 'refresh',
        ) );
        $wp_customize->add_control( 'amp-enable-sidebar', array(
