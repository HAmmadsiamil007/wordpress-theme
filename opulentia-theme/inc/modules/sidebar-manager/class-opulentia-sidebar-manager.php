...
class Opulentia_Sidebar_Manager {
    ...
    public function register_customizer( $wp_customize ) {
        $wp_customize->add_section( 'opulentia_sidebars', array(
            'title'    => __( 'Sidebar Manager', 'opulentia' ),
            'panel'    => 'Opulentia_global_settings',
            'priority' => 110,
        ) );

        $wp_customize->add_setting( 'custom-sidebars', array(
            'default'           => array(),
            'sanitize_callback' => array( $this, 'sanitize_sidebars' ),
            'transport'         => 'refresh',
        ) );
        $wp_customize->add_control( new WP_Customize_Control( $wp_customize, 'custom-sidebars', array(
        ...
        $wp_customize->add_setting( 'default-sidebar-post', array(
            'default'           => 'sidebar-1',
            'sanitize_callback' => 'sanitize_text_field',
            'transport'         => 'refresh',
        ) );
        $wp_customize->add_control( 'default-sidebar-post', array(
        ...
        $wp_customize->add_setting( 'default-sidebar-page', array(
            'default'           => 'sidebar-1',
            'sanitize_callback' => 'sanitize_text_field',
            'transport'         => 'refresh',
        ) );
        $wp_customize->add_control( 'default-sidebar-page', array(
        ...
        if ( class_exists( 'WooCommerce' ) ) {
            $wp_customize->add_setting( 'default-sidebar-product', array(
                'default'           => 'sidebar-1',
                'sanitize_callback' => 'sanitize_text_field',
                'transport'         => 'refresh',
            ) );
            $wp_customize->add_control( 'default-sidebar-product', array(
