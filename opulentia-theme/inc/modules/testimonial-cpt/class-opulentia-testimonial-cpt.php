...
class Opulentia_Testimonial_Cpt {
    ...
    public function register_customizer( $wp_customize ) {
        $wp_customize->add_section( 'opulentia_testimonials', array(
            'title'    => __( 'Testimonials', 'opulentia' ),
            'panel'    => 'Opulentia_global_settings',
            'priority' => 130,
        ) );

        $wp_customize->add_setting( 'testimonial-style', array(
            'default'           => 'grid',
            'sanitize_callback' => 'sanitize_text_field',
            'transport'         => 'refresh',
        ) );
        $wp_customize->add_control( 'testimonial-style', array(
        ...
        $wp_customize->add_setting( 'testimonial-columns', array(
            'default'           => 2,
            'sanitize_callback' => 'absint',
            'transport'         => 'refresh',
        ) );
        $wp_customize->add_control( 'testimonial-columns', array(
        ...
        $wp_customize->add_setting( 'testimonial-autoplay', array(
            'default'           => true,
            'sanitize_callback' => 'wp_validate_boolean',
            'transport'         => 'refresh',
        ) );
        $wp_customize->add_control( 'testimonial-autoplay', array(
            'label'   => __( 'Autoplay Slider', 'opulentia' ),
            'section' => 'opulentia_testimonials',
            'type'    => 'checkbox',
        ) );

        $wp_customize->add_setting( 'testimonial-autoplay-speed', array(
            'default'           => 5000,
            'sanitize_callback' => 'absint',
            'transport'         => 'refresh',
        ) );
        $wp_customize->add_control( 'testimonial-autoplay-speed', array(
        ...
        $wp_customize->add_setting( 'testimonial-show-rating', array(
            'default'           => true,
            'sanitize_callback' => 'wp_validate_boolean',
            'transport'         => 'refresh',
        ) );
        $wp_customize->add_control( 'testimonial-show-rating', array(
