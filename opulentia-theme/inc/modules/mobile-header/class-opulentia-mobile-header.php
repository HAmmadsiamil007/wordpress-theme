...
class Opulentia_Mobile_Header {
    ...
    public function register_customizer( $wp_customize ) {
        $wp_customize->add_section( 'opulentia_mobile_header', array(
            'title'    => __( 'Mobile Header', 'opulentia' ),
            'panel'    => 'Opulentia_header_settings',
            'priority' => 35,
        ) );

        $wp_customize->add_setting( 'mobile-header-breakpoint', array(
            'default'           => 992,
            'sanitize_callback' => 'absint',
            'transport'         => 'refresh',
        ) );
        $wp_customize->add_control( 'mobile-header-breakpoint', array(
            ...
            'type'        => 'number',
            'input_attrs' => array( 'min' => 320, 'max' => 1200, 'step' => 1 ),
        ) );

        $wp_customize->add_setting( 'mobile-header-logo', array(
            'default'           => '',
            'sanitize_callback' => 'esc_url_raw',
            'transport'         => 'refresh',
        ) );
        $wp_customize->add_control( new WP_Customize_Image_Control( $wp_customize, 'mobile-header-logo', array(
            'label'       => __( 'Mobile Logo', 'opulentia' ),
            'description' => __( 'Separate logo for mobile header.', 'opulentia' ),
            'section'     => 'opulentia_mobile_header',
        ) ) );

        $wp_customize->add_setting( 'mobile-header-menu-style', array(
            'default'           => 'hamburger',
            'sanitize_callback' => 'sanitize_text_field',
            'transport'         => 'refresh',
        ) );
        $wp_customize->add_control( 'mobile-header-menu-style', array(
        ...
        $wp_customize->add_setting( 'mobile-header-menu-animation', array(
            'default'           => 'slide',
            'sanitize_callback' => 'sanitize_text_field',
            'transport'         => 'refresh',
        ) );
        $wp_customize->add_control( 'mobile-header-menu-animation', array(
        ...
        $wp_customize->add_setting( 'mobile-header-bg-color', array(
            'default'           => 'var(--color-primary-dark)',
            'sanitize_callback' => 'sanitize_text_field',
            'transport'         => 'postMessage',
        ) );
        $wp_customize->add_control( 'mobile-header-bg-color', array(
        ...
        $wp_customize->add_setting( 'mobile-header-text-color', array(
            'default'           => 'var(--color-text)',
            'sanitize_callback' => 'sanitize_text_field',
            'transport'         => 'postMessage',
        ) );
        $wp_customize->add_control( 'mobile-header-text-color', array(
        ...
        $wp_customize->add_setting( 'mobile-header-active-color', array(
            'default'           => 'var(--color-gold)',
            'sanitize_callback' => 'sanitize_text_field',
            'transport'         => 'postMessage',
        ) );
        $wp_customize->add_control( 'mobile-header-active-color', array(
        ...
        $wp_customize->add_setting( 'mobile-header-sticky', array(
            'default'           => true,
            'sanitize_callback' => 'wp_validate_boolean',
            'transport'         => 'refresh',
        ) );
        $wp_customize->add_control( 'mobile-header-sticky', array(
            'label'       => __( 'Sticky Mobile Header', 'opulentia' ),
            'section'     => 'opulentia_mobile_header',
            'type'        => 'checkbox',
        ) );

        $wp_customize->add_setting( 'mobile-header-search', array(
            'default'           => true,
            'sanitize_callback' => 'wp_validate_boolean',
            'transport'         => 'refresh',
        ) );
        $wp_customize->add_control( 'mobile-header-search', array(
            'label'       => __( 'Show Search Icon', 'opulentia' ),
            'section'     => 'opulentia_mobile_header',
            'type'        => 'checkbox',
        ) );

        $wp_customize->add_setting( 'mobile-header-cart', array(
            'default'           => true,
            'sanitize_callback' => 'wp_validate_boolean',
            'transport'         => 'refresh',
        ) );
        $wp_customize->add_control( 'mobile-header-cart', array(
