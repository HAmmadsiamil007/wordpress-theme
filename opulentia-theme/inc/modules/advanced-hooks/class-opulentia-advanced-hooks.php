...
class Opulentia_Advanced_Hooks {
    ...
    public function register_meta_fields() {
        ...
        foreach ( $meta_fields as $key => $sanitize_cb ) {
            register_post_meta( 'opulentia_hook', $key, array(
                'show_in_rest'  => false,
                'single'        => true,
                'type'          => 'string',
    ...
    public function save_meta_boxes( $post_id ) {
        ...
        if ( isset( $_POST['_opulentia_hook_location'] ) ) {
            update_post_meta( $post_id, '_opulentia_hook_location',
        ...
        if ( isset( $_POST['_opulentia_hook_code_type'] ) ) {
            update_post_meta( $post_id, '_opulentia_hook_code_type',
        ...
        if ( isset( $_POST['_opulentia_hook_code'] ) ) {
            update_post_meta( $post_id, '_opulentia_hook_code',
        ...
        if ( isset( $_POST['_opulentia_hook_priority'] ) ) {
            update_post_meta( $post_id, '_opulentia_hook_priority',
