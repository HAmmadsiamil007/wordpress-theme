...
class Opulentia_Ajax_Filtering {
    ...
    public function register_customizer( $wp_customize ) {
        $wp_customize->add_section( 'opulentia_ajax_filtering', array(
            'title'    => __( 'AJAX Product Filtering', 'opulentia' ),
            'panel'    => 'Opulentia_woocommerce',
            'priority' => 36,
        ) );

        $wp_customize->add_setting( 'ajax-filter-enable', array(
            'default'           => true,
            'sanitize_callback' => 'wp_validate_boolean',
            'transport'         => 'refresh',
        ) );
        $wp_customize->add_control( 'ajax-filter-enable', array(
            'label'   => __( 'Enable AJAX Filtering', 'opulentia' ),
            'section' => 'opulentia_ajax_filtering',
            'type'    => 'checkbox',
        ) );

        $wp_customize->add_setting( 'ajax-filter-position', array(
            'default'           => 'sidebar',
            'sanitize_callback' => 'sanitize_text_field',
            'transport'         => 'refresh',
        ) );
        $wp_customize->add_control( 'ajax-filter-position', array(
        ...
        $wp_customize->add_setting( 'ajax-filter-price', array(
            'default'           => true,
            'sanitize_callback' => 'wp_validate_boolean',
            'transport'         => 'refresh',
        ) );
        $wp_customize->add_control( 'ajax-filter-price', array(
            'label'   => __( 'Show Price Filter', 'opulentia' ),
            'section' => 'opulentia_ajax_filtering',
            'type'    => 'checkbox',
        ) );

        $wp_customize->add_setting( 'ajax-filter-categories', array(
            'default'           => true,
            'sanitize_callback' => 'wp_validate_boolean',
            'transport'         => 'refresh',
        ) );
        $wp_customize->add_control( 'ajax-filter-categories', array(
            'label'   => __( 'Show Category Filter', 'opulentia' ),
            'section' => 'opulentia_ajax_filtering',
            'type'    => 'checkbox',
        ) );

        $wp_customize->add_setting( 'ajax-filter-attributes', array(
            'default'           => true,
            'sanitize_callback' => 'wp_validate_boolean',
            'transport'         => 'refresh',
        ) );
        $wp_customize->add_control( 'ajax-filter-attributes', array(
