...
class Opulentia_Author_Box {
    ...
    public function register_customizer( $wp_customize ) {
        $wp_customize->add_section( 'opulentia_author_box', array(
            'title'    => __( 'Author Box', 'opulentia' ),
            'panel'    => 'Opulentia_global_settings',
            'priority' => 130,
        ) );

        $wp_customize->add_setting( 'author-box-enable', array(
            'default'           => true,
            'sanitize_callback' => 'wp_validate_boolean',
            'transport'         => 'refresh',
        ) );
        $wp_customize->add_control( 'author-box-enable', array(
            'label'   => __( 'Enable Author Box on Single Posts', 'opulentia' ),
            'section' => 'opulentia_author_box',
            'type'    => 'checkbox',
        ) );

        $wp_customize->add_setting( 'author-box-show-avatar', array(
            'default'           => true,
            'sanitize_callback' => 'wp_validate_boolean',
            'transport'         => 'refresh',
        ) );
        $wp_customize->add_control( 'author-box-show-avatar', array(
            'label'   => __( 'Show Avatar', 'opulentia' ),
            'section' => 'opulentia_author_box',
            'type'    => 'checkbox',
        ) );

        $wp_customize->add_setting( 'author-box-show-recent', array(
            'default'           => true,
            'sanitize_callback' => 'wp_validate_boolean',
            'transport'         => 'refresh',
        ) );
        $wp_customize->add_control( 'author-box-show-recent', array(
            'label'   => __( 'Show Recent Posts', 'opulentia' ),
            'section' => 'opulentia_author_box',
            'type'    => 'checkbox',
        ) );

        $wp_customize->add_setting( 'author-box-recent-count', array(
            'default'           => 3,
            'sanitize_callback' => 'absint',
            'transport'         => 'refresh',
        ) );
        $wp_customize->add_control( 'author-box-recent-count', array(
