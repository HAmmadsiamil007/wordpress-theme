...
class Opulentia_Social_Sharing {
    ...
    public function register_customizer( $wp_customize ) {
        $wp_customize->add_section( 'opulentia_social_sharing', array(
            'title'    => __( 'Social Sharing', 'opulentia' ),
            'panel'    => 'Opulentia_global_settings',
            'priority' => 105,
        ) );

        $wp_customize->add_setting( 'social-sharing-enable', array(
            'default'           => true,
            'sanitize_callback' => 'wp_validate_boolean',
            'transport'         => 'refresh',
        ) );
        $wp_customize->add_control( 'social-sharing-enable', array(
            'label'   => __( 'Enable Social Sharing', 'opulentia' ),
            'section' => 'opulentia_social_sharing',
            'type'    => 'checkbox',
        ) );

        $wp_customize->add_setting( 'social-sharing-position', array(
            'default'           => 'after',
            'sanitize_callback' => 'sanitize_text_field',
            'transport'         => 'refresh',
        ) );
        $wp_customize->add_control( 'social-sharing-position', array(
        ...
        $wp_customize->add_setting( 'social-sharing-style', array(
            'default'           => 'icons-labels',
            'sanitize_callback' => 'sanitize_text_field',
            'transport'         => 'refresh',
        ) );
        $wp_customize->add_control( 'social-sharing-style', array(
        ...
        $wp_customize->add_setting( 'social-sharing-posts', array(
            'default'           => true,
            'sanitize_callback' => 'wp_validate_boolean',
            'transport'         => 'refresh',
        ) );
        $wp_customize->add_control( 'social-sharing-posts', array(
            'label'   => __( 'Show on Posts', 'opulentia' ),
            'section' => 'opulentia_social_sharing',
            'type'    => 'checkbox',
        ) );

        $wp_customize->add_setting( 'social-sharing-pages', array(
            'default'           => false,
            'sanitize_callback' => 'wp_validate_boolean',
            'transport'         => 'refresh',
        ) );
        $wp_customize->add_control( 'social-sharing-pages', array(
            'label'   => __( 'Show on Pages', 'opulentia' ),
            'section' => 'opulentia_social_sharing',
            'type'    => 'checkbox',
        ) );

        $wp_customize->add_setting( 'social-sharing-products', array(
            'default'           => true,
            'sanitize_callback' => 'wp_validate_boolean',
            'transport'         => 'refresh',
        ) );
        $wp_customize->add_control( 'social-sharing-products', array(
            'label'   => __( 'Show on Products', 'opulentia' ),
            'section' => 'opulentia_social_sharing',
            'type'    => 'checkbox',
        ) );

        $wp_customize->add_setting( 'social-sharing-accent', array(
            'default'           => 'var(--color-gold)',
            'sanitize_callback' => 'sanitize_text_field',
            'transport'         => 'postMessage',
        ) );
        $wp_customize->add_control( 'social-sharing-accent', array(
        ...
        foreach ( $this->get_networks() as $key => $label ) {
            $wp_customize->add_setting( 'social-sharing-' . $key, array(
                'default'           => true,
                'sanitize_callback' => 'wp_validate_boolean',
                'transport'         => 'refresh',
            ) );
            $wp_customize->add_control( 'social-sharing-' . $key, array(
                'label'   => $label,
                'section' => 'opulentia_social_sharing',
                'type'    => 'checkbox',
            ) );
