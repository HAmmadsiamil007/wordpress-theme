...
class Opulentia_Responsive_Controls {
    ...
    private function get_breakpoints() {
        ...
        return array( 'tablet' => 992, 'mobile' => 576 );
    }

    public function customize_register( $wp_customize ) {
        $wp_customize->add_panel( 'opulentia_responsive', array(
        ...
        // ── Breakpoints ──
        $wp_customize->add_section( 'op_responsive_breakpoints_section', array(
            'title' => __( 'Breakpoints', 'opulentia' ),
            'panel' => 'opulentia_responsive',
        ) );

        $wp_customize->add_setting( 'op_responsive_breakpoints', array(
            'default'           => '',
            'sanitize_callback' => 'sanitize_text_field',
            'transport'         => 'refresh',
        ) );

        $wp_customize->add_control( 'op_responsive_breakpoints', array(
        ...
        // ── Visibility ──
        $wp_customize->add_section( 'op_responsive_visibility', array(
            'title' => __( 'Visibility', 'opulentia' ),
            'panel' => 'opulentia_responsive',
        ) );

        $wp_customize->add_setting( 'op_responsive_hide_desktop', array(
            'default'           => '',
            'sanitize_callback' => 'sanitize_text_field',
            'transport'         => 'refresh',
        ) );

        $wp_customize->add_control( 'op_responsive_hide_desktop', array(
        ...
        $wp_customize->add_setting( 'op_responsive_hide_tablet', array(
            'default'           => '',
            'sanitize_callback' => 'sanitize_text_field',
            'transport'         => 'refresh',
        ) );

        $wp_customize->add_control( 'op_responsive_hide_tablet', array(
        ...
        $wp_customize->add_setting( 'op_responsive_hide_mobile', array(
            'default'           => 'sidebar',
            'sanitize_callback' => 'sanitize_text_field',
            'transport'         => 'refresh',
        ) );

        $wp_customize->add_control( 'op_responsive_hide_mobile', array(
        ...
        $wp_customize->add_section( 'op_responsive_typography', array(
        ...
        foreach ( $devices as $device => $device_label ) {
            $wp_customize->add_setting( "op_responsive_{$device}_body_size", array(
                'default'           => '',
                'sanitize_callback' => 'sanitize_text_field',
                'transport'         => 'refresh',
            ) );

            $wp_customize->add_control( "op_responsive_{$device}_body_size", array(
            ...
            $wp_customize->add_setting( "op_responsive_{$device}_heading_scale", array(
                'default'           => '',
                'sanitize_callback' => 'sanitize_text_field',
                'transport'         => 'refresh',
            ) );

            $wp_customize->add_control( "op_responsive_{$device}_heading_scale", array(
                ...
                'section'     => 'op_responsive_typography',
                'type'        => 'number',
                'input_attrs' => array( 'step' => '0.05', 'min' => '0.5', 'max' => '1.5' ),
            ) );

            $wp_customize->add_setting( "op_responsive_{$device}_h1_size", array(
                'default'           => '',
                'sanitize_callback' => 'sanitize_text_field',
                'transport'         => 'refresh',
            ) );

            $wp_customize->add_control( "op_responsive_{$device}_h1_size", array(
            ...
            $wp_customize->add_setting( "op_responsive_{$device}_h2_size", array(
                'default'           => '',
                'sanitize_callback' => 'sanitize_text_field',
                'transport'         => 'refresh',
            ) );

            $wp_customize->add_control( "op_responsive_{$device}_h2_size", array(
            ...
            $wp_customize->add_setting( "op_responsive_{$device}_h3_size", array(
                'default'           => '',
                'sanitize_callback' => 'sanitize_text_field',
                'transport'         => 'refresh',
            ) );

            $wp_customize->add_control( "op_responsive_{$device}_h3_size", array(
            ...
            $wp_customize->add_setting( "op_responsive_{$device}_content_width", array(
                'default'           => '',
                'sanitize_callback' => 'sanitize_text_field',
                'transport'         => 'refresh',
            ) );

            $wp_customize->add_control( "op_responsive_{$device}_content_width", array(
...
";
        ...
        $devices = array( 'tablet' => $bp['tablet'], 'mobile' => $bp['mobile'] );
