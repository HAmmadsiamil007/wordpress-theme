...
class Opulentia_Portfolio_Cpt {
    ...
    public function register_customizer( $wp_customize ) {
        $wp_customize->add_section( 'opulentia_portfolio', array(
            'title'    => __( 'Portfolio', 'opulentia' ),
            'panel'    => 'Opulentia_global_settings',
            'priority' => 120,
        ) );

        $wp_customize->add_setting( 'portfolio-grid-columns', array(
            'default'           => 3,
            'sanitize_callback' => 'absint',
            'transport'         => 'refresh',
        ) );
        $wp_customize->add_control( 'portfolio-grid-columns', array(
        ...
        $wp_customize->add_setting( 'portfolio-grid-gap', array(
            'default'           => 20,
            'sanitize_callback' => 'absint',
            'transport'         => 'refresh',
        ) );
        $wp_customize->add_control( 'portfolio-grid-gap', array(
        ...
        $wp_customize->add_setting( 'portfolio-hover-effect', array(
            'default'           => 'zoom',
            'sanitize_callback' => 'sanitize_text_field',
            'transport'         => 'refresh',
        ) );
        $wp_customize->add_control( 'portfolio-hover-effect', array(
    ...
    public function load_single_template( $template ) {
        ...
        if ( 'portfolio' === $post->post_type ) {
            ...
            if ( ! $found ) {
                $module_dir = dirname( __FILE__ ) . '/templates/single-portfolio.php';
