...
class Opulentia_Popup_Builder {
    ...
    public function customize_register( $wp_customize ) {
        $wp_customize->add_panel( 'opulentia_popups', array(
        ...
        // ── Global Toggle ──
        $wp_customize->add_section( 'op_popup_global', array(
            'title'       => __( 'Global Settings', 'opulentia' ),
            'panel'       => 'opulentia_popups',
            'priority'    => 1,
        ) );

        $wp_customize->add_setting( 'op_popup_enable', array(
            'default'           => false,
            'sanitize_callback' => 'wp_validate_boolean',
            'transport'         => 'refresh',
        ) );

        $wp_customize->add_control( 'op_popup_enable', array(
        ...
        $wp_customize->add_setting( 'op_popup_type', array(
            'default'           => 'modal',
            'sanitize_callback' => 'sanitize_text_field',
            'transport'         => 'refresh',
        ) );

        $wp_customize->add_control( 'op_popup_type', array(
        ...
        // ── Content ──
        $wp_customize->add_section( 'op_popup_content', array(
            'title'       => __( 'Content', 'opulentia' ),
            'panel'       => 'opulentia_popups',
            'priority'    => 5,
        ) );

        $wp_customize->add_setting( 'op_popup_title', array(
            'default'           => '',
            'sanitize_callback' => 'wp_kses_post',
            'transport'         => 'refresh',
        ) );

        $wp_customize->add_control( 'op_popup_title', array(
            'label'       => __( 'Title', 'opulentia' ),
            'section'     => 'op_popup_content',
            'type'        => 'text',
        ) );

        $wp_customize->add_setting( 'op_popup_text', array(
            'default'           => '',
            'sanitize_callback' => 'wp_kses_post',
            'transport'         => 'refresh',
        ) );

        $wp_customize->add_control( 'op_popup_text', array(
            'label'       => __( 'Body Text', 'opulentia' ),
            'section'     => 'op_popup_content',
            'type'        => 'textarea',
        ) );

        $wp_customize->add_setting( 'op_popup_btn_text', array(
            'default'           => __( 'Get Started', 'opulentia' ),
            'sanitize_callback' => 'sanitize_text_field',
            'transport'         => 'refresh',
        ) );

        $wp_customize->add_control( 'op_popup_btn_text', array(
            'label'       => __( 'Button Text', 'opulentia' ),
            'section'     => 'op_popup_content',
            'type'        => 'text',
        ) );

        $wp_customize->add_setting( 'op_popup_btn_url', array(
            'default'           => '',
            'sanitize_callback' => 'esc_url_raw',
            'transport'         => 'refresh',
        ) );

        $wp_customize->add_control( 'op_popup_btn_url', array(
        ...
        // ── Triggers ──
        $wp_customize->add_section( 'op_popup_triggers', array(
            'title'       => __( 'Triggers', 'opulentia' ),
            'panel'       => 'opulentia_popups',
            'priority'    => 10,
        ) );

        $wp_customize->add_setting( 'op_popup_trigger_type', array(
            'default'           => 'time',
            'sanitize_callback' => 'sanitize_text_field',
            'transport'         => 'refresh',
        ) );

        $wp_customize->add_control( 'op_popup_trigger_type', array(
        ...
        $wp_customize->add_setting( 'op_popup_delay', array(
            'default'           => 3,
            'sanitize_callback' => 'absint',
            'transport'         => 'refresh',
        ) );

        $wp_customize->add_control( 'op_popup_delay', array(
        ...
        $wp_customize->add_setting( 'op_popup_scroll_percent', array(
            'default'           => 50,
            'sanitize_callback' => 'absint',
            'transport'         => 'refresh',
        ) );

        $wp_customize->add_control( 'op_popup_scroll_percent', array(
        ...
        $wp_customize->add_setting( 'op_popup_click_selector', array(
            'default'           => '',
            'sanitize_callback' => 'sanitize_text_field',
            'transport'         => 'refresh',
        ) );

        $wp_customize->add_control( 'op_popup_click_selector', array(
        ...
        // ── Frequency ──
        $wp_customize->add_section( 'op_popup_frequency', array(
            'title'       => __( 'Frequency', 'opulentia' ),
            'panel'       => 'opulentia_popups',
            'priority'    => 15,
        ) );

        $wp_customize->add_setting( 'op_popup_frequency', array(
            'default'           => 'session',
            'sanitize_callback' => 'sanitize_text_field',
            'transport'         => 'refresh',
        ) );

        $wp_customize->add_control( 'op_popup_frequency', array(
        ...
        // ── Design ──
        $wp_customize->add_section( 'op_popup_design', array(
            'title'       => __( 'Design', 'opulentia' ),
            'panel'       => 'opulentia_popups',
            'priority'    => 20,
        ) );

        $wp_customize->add_setting( 'op_popup_bg_color', array(
            'default'           => '#1a1a1a',
            'sanitize_callback' => 'sanitize_hex_color',
            'transport'         => 'refresh',
        ) );

        $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'op_popup_bg_color', array(
            'label'   => __( 'Background Color', 'opulentia' ),
            'section' => 'op_popup_design',
        ) ) );

        $wp_customize->add_setting( 'op_popup_text_color', array(
            'default'           => '#f5f5f5',
            'sanitize_callback' => 'sanitize_hex_color',
            'transport'         => 'refresh',
        ) );

        $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'op_popup_text_color', array(
            'label'   => __( 'Text Color', 'opulentia' ),
            'section' => 'op_popup_design',
        ) ) );

        $wp_customize->add_setting( 'op_popup_accent_color', array(
            'default'           => '#b8860b',
            'sanitize_callback' => 'sanitize_hex_color',
            'transport'         => 'refresh',
        ) );

        $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'op_popup_accent_color', array(
            'label'   => __( 'Accent/Button Color', 'opulentia' ),
            'section' => 'op_popup_design',
        ) ) );

        $wp_customize->add_setting( 'op_popup_overlay_color', array(
            'default'           => 'rgba(0,0,0,0.7)',
            'sanitize_callback' => 'sanitize_text_field',
            'transport'         => 'refresh',
        ) );

        $wp_customize->add_control( 'op_popup_overlay_color', array(
        ...
        $wp_customize->add_setting( 'op_popup_width', array(
            'default'           => 500,
            'sanitize_callback' => 'absint',
            'transport'         => 'refresh',
        ) );

        $wp_customize->add_control( 'op_popup_width', array(
        ...
        $wp_customize->add_setting( 'op_popup_border_radius', array(
            'default'           => 8,
            'sanitize_callback' => 'absint',
            'transport'         => 'refresh',
        ) );

        $wp_customize->add_control( 'op_popup_border_radius', array(
        ...
        // ── Display Conditions ──
        $wp_customize->add_section( 'op_popup_conditions', array(
            'title'       => __( 'Display Conditions', 'opulentia' ),
            'panel'       => 'opulentia_popups',
            'priority'    => 25,
        ) );

        $wp_customize->add_setting( 'op_popup_show_on', array(
            'default'           => 'all',
            'sanitize_callback' => 'sanitize_text_field',
            'transport'         => 'refresh',
        ) );

        $wp_customize->add_control( 'op_popup_show_on', array(
        ...
        $wp_customize->add_setting( 'op_popup_devices', array(
            'default'           => 'all',
            'sanitize_callback' => 'sanitize_text_field',
            'transport'         => 'refresh',
        ) );

        $wp_customize->add_control( 'op_popup_devices', array(
        ...
        $wp_customize->add_setting( 'op_popup_user_roles', array(
            'default'           => 'all',
            'sanitize_callback' => 'sanitize_text_field',
            'transport'         => 'refresh',
        ) );

        $wp_customize->add_control( 'op_popup_user_roles', array(
    ...
    public function enqueue_scripts() {
        ...
        wp_localize_script( 'opulentia-popup', 'OpulentiaPopup', array(
            'enable'         => true,
