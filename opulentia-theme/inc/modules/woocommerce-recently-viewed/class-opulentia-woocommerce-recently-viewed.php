...
class Opulentia_WooCommerce_Recently_Viewed {
    ...
    public function register_customizer( $wp_customize ) {
        $wp_customize->add_section( 'opulentia_wc_recently_viewed', array(
            'title'    => __( 'Recently Viewed Products', 'opulentia' ),
            'panel'    => 'Opulentia_woocommerce',
            'priority' => 30,
        ) );

        $wp_customize->add_setting( 'wc-recently-viewed-enable', array(
            'default'           => true,
            'sanitize_callback' => 'wp_validate_boolean',
            'transport'         => 'refresh',
        ) );
        $wp_customize->add_control( 'wc-recently-viewed-enable', array(
            'label'   => __( 'Enable Tracking', 'opulentia' ),
            'section' => 'opulentia_wc_recently_viewed',
            'type'    => 'checkbox',
        ) );

        $wp_customize->add_setting( 'wc-recently-viewed-count', array(
            'default'           => 6,
            'sanitize_callback' => 'absint',
            'transport'         => 'refresh',
        ) );
        $wp_customize->add_control( 'wc-recently-viewed-count', array(
        ...
        $wp_customize->add_setting( 'wc-recently-viewed-columns', array(
            'default'           => 4,
            'sanitize_callback' => 'absint',
            'transport'         => 'refresh',
        ) );
        $wp_customize->add_control( 'wc-recently-viewed-columns', array(
        ...
        $wp_customize->add_setting( 'wc-recently-viewed-title', array(
            'default'           => __( 'Recently Viewed', 'opulentia' ),
            'sanitize_callback' => 'sanitize_text_field',
            'transport'         => 'postMessage',
        ) );
        $wp_customize->add_control( 'wc-recently-viewed-title', array(
            'label'   => __( 'Section Title', 'opulentia' ),
            'section' => 'opulentia_wc_recently_viewed',
            'type'    => 'text',
        ) );

        $wp_customize->add_setting( 'wc-recently-viewed-single', array(
            'default'           => true,
            'sanitize_callback' => 'wp_validate_boolean',
            'transport'         => 'refresh',
        ) );
        $wp_customize->add_control( 'wc-recently-viewed-single', array(
...
class Opulentia_Recently_Viewed_Widget extends WP_Widget {
    public function __construct() {
        parent::__construct( 'op_recently_viewed', __( 'Recently Viewed Products', 'opulentia' ), array(
