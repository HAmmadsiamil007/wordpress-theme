...
class Opulentia_Form_Styler {
    ...
    public function customize_register( $wp_customize ) {
        $wp_customize->add_panel( 'opulentia_forms', array(
        ...
        // ── Input Fields ──
        $wp_customize->add_section( 'op_forms_inputs', array(
            'title' => __( 'Input Fields', 'opulentia' ),
            'panel' => 'opulentia_forms',
        ) );

        $wp_customize->add_setting( 'op_forms_input_bg', array(
            'default'           => '#222',
            'sanitize_callback' => 'sanitize_hex_color',
        ) );

        $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'op_forms_input_bg', array(
            'label'   => __( 'Background', 'opulentia' ),
            'section' => 'op_forms_inputs',
        ) ) );

        $wp_customize->add_setting( 'op_forms_input_border', array(
            'default'           => '#333',
            'sanitize_callback' => 'sanitize_hex_color',
        ) );

        $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'op_forms_input_border', array(
            'label'   => __( 'Border Color', 'opulentia' ),
            'section' => 'op_forms_inputs',
        ) ) );

        $wp_customize->add_setting( 'op_forms_input_border_focus', array(
            'default'           => '#c9a96e',
            'sanitize_callback' => 'sanitize_hex_color',
        ) );

        $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'op_forms_input_border_focus', array(
            'label'   => __( 'Border Color (Focus)', 'opulentia' ),
            'section' => 'op_forms_inputs',
        ) ) );

        $wp_customize->add_setting( 'op_forms_input_radius', array(
            'default'           => '4px',
            'sanitize_callback' => 'sanitize_text_field',
        ) );

        $wp_customize->add_control( 'op_forms_input_radius', array(
        ...
        $wp_customize->add_setting( 'op_forms_input_padding', array(
            'default'           => '12px 16px',
            'sanitize_callback' => 'sanitize_text_field',
        ) );

        $wp_customize->add_control( 'op_forms_input_padding', array(
        ...
        $wp_customize->add_setting( 'op_forms_input_text', array(
            'default'           => '#f5f5f5',
            'sanitize_callback' => 'sanitize_hex_color',
        ) );

        $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'op_forms_input_text', array(
            'label'   => __( 'Text Color', 'opulentia' ),
            'section' => 'op_forms_inputs',
        ) ) );

        $wp_customize->add_setting( 'op_forms_input_size', array(
            'default'           => '16px',
            'sanitize_callback' => 'sanitize_text_field',
        ) );

        $wp_customize->add_control( 'op_forms_input_size', array(
        ...
        $wp_customize->add_setting( 'op_forms_input_placeholder', array(
            'default'           => '#666',
            'sanitize_callback' => 'sanitize_hex_color',
        ) );

        $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'op_forms_input_placeholder', array(
            'label'   => __( 'Placeholder Color', 'opulentia' ),
            'section' => 'op_forms_inputs',
        ) ) );

        // ── Labels ──
        $wp_customize->add_section( 'op_forms_labels', array(
            'title' => __( 'Labels', 'opulentia' ),
            'panel' => 'opulentia_forms',
        ) );

        $wp_customize->add_setting( 'op_forms_label_color', array(
            'default'           => '#c9a96e',
            'sanitize_callback' => 'sanitize_hex_color',
        ) );

        $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'op_forms_label_color', array(
            'label'   => __( 'Label Color', 'opulentia' ),
            'section' => 'op_forms_labels',
        ) ) );

        $wp_customize->add_setting( 'op_forms_label_size', array(
            'default'           => '14px',
            'sanitize_callback' => 'sanitize_text_field',
        ) );

        $wp_customize->add_control( 'op_forms_label_size', array(
        ...
        $wp_customize->add_setting( 'op_forms_label_weight', array(
            'default'           => '600',
            'sanitize_callback' => 'sanitize_text_field',
        ) );

        $wp_customize->add_control( 'op_forms_label_weight', array(
        ...
        // ── Submit Button ──
        $wp_customize->add_section( 'op_forms_button', array(
            'title' => __( 'Submit Button', 'opulentia' ),
            'panel' => 'opulentia_forms',
        ) );

        $wp_customize->add_setting( 'op_forms_btn_bg', array(
            'default'           => '#b8860b',
            'sanitize_callback' => 'sanitize_hex_color',
        ) );

        $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'op_forms_btn_bg', array(
            'label'   => __( 'Background', 'opulentia' ),
            'section' => 'op_forms_button',
        ) ) );

        $wp_customize->add_setting( 'op_forms_btn_bg_hover', array(
            'default'           => '#d4a843',
            'sanitize_callback' => 'sanitize_hex_color',
        ) );

        $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'op_forms_btn_bg_hover', array(
            'label'   => __( 'Background (Hover)', 'opulentia' ),
            'section' => 'op_forms_button',
        ) ) );

        $wp_customize->add_setting( 'op_forms_btn_text', array(
            'default'           => '#fff',
            'sanitize_callback' => 'sanitize_hex_color',
        ) );

        $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'op_forms_btn_text', array(
            'label'   => __( 'Text Color', 'opulentia' ),
            'section' => 'op_forms_button',
        ) ) );

        $wp_customize->add_setting( 'op_forms_btn_radius', array(
            'default'           => '4px',
            'sanitize_callback' => 'sanitize_text_field',
        ) );

        $wp_customize->add_control( 'op_forms_btn_radius', array(
            'label'   => __( 'Border Radius', 'opulentia' ),
            'section' => 'op_forms_button',
            'type'    => 'text',
            'input_attrs' => array( 'placeholder' => '4px' ),
        ...
        $wp_customize->add_setting( 'op_forms_btn_padding', array(
            'default'           => '14px 32px',
            'sanitize_callback' => 'sanitize_text_field',
        ) );

        $wp_customize->add_control( 'op_forms_btn_padding', array(
            'label'   => __( 'Padding', 'opulentia' ),
            'section' => 'op_forms_button',
            'type'    => 'text',
        ...
        $wp_customize->add_setting( 'op_forms_btn_size', array(
            'default'           => '16px',
            'sanitize_callback' => 'sanitize_text_field',
        ) );

        $wp_customize->add_control( 'op_forms_btn_size', array(
            'label'   => __( 'Font Size', 'opulentia' ),
            'section' => 'op_forms_button',
            'type'    => 'text',
            'input_attrs' => array( 'placeholder' => '16px' ),
        ...
        // ── Messages ──
        $wp_customize->add_section( 'op_forms_messages', array(
            'title' => __( 'Messages', 'opulentia' ),
            'panel' => 'opulentia_forms',
        ) );

        $wp_customize->add_setting( 'op_forms_error_bg', array(
            'default'           => '#2d1a1a',
            'sanitize_callback' => 'sanitize_hex_color',
        ) );

        $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'op_forms_error_bg', array(
            'label'   => __( 'Error Message Background', 'opulentia' ),
            'section' => 'op_forms_messages',
        ) ) );

        $wp_customize->add_setting( 'op_forms_error_text', array(
            'default'           => '#ff6b6b',
            'sanitize_callback' => 'sanitize_hex_color',
        ) );

        $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'op_forms_error_text', array(
            'label'   => __( 'Error Message Text', 'opulentia' ),
            'section' => 'op_forms_messages',
        ) ) );

        $wp_customize->add_setting( 'op_forms_success_bg', array(
            'default'           => '#1a2d1a',
            'sanitize_callback' => 'sanitize_hex_color',
        ) );

        $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'op_forms_success_bg', array(
            'label'   => __( 'Success Message Background', 'opulentia' ),
            'section' => 'op_forms_messages',
        ) ) );

        $wp_customize->add_setting( 'op_forms_success_text', array(
            'default'           => '#4caf50',
            'sanitize_callback' => 'sanitize_hex_color',
        ) );

        $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'op_forms_success_text', array(
            'label'   => __( 'Success Message Text', 'opulentia' ),
            'section' => 'op_forms_messages',
        ) ) );

        // ── Checkbox / Radio ──
        $wp_customize->add_section( 'op_forms_checks', array(
            'title' => __( 'Checkbox & Radio', 'opulentia' ),
            'panel' => 'opulentia_forms',
        ) );

        $wp_customize->add_setting( 'op_forms_check_accent', array(
            'default'           => '#c9a96e',
            'sanitize_callback' => 'sanitize_hex_color',
        ) );

        $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'op_forms_check_accent', array(
            'label'   => __( 'Accent Color', 'opulentia' ),
            'section' => 'op_forms_checks',
        ) ) );

        $wp_customize->add_setting( 'op_forms_check_bg', array(
            'default'           => '#222',
            'sanitize_callback' => 'sanitize_hex_color',
        ) );

        $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'op_forms_check_bg', array(
            'label'   => __( 'Background', 'opulentia' ),
            'section' => 'op_forms_checks',
        ) ) );
    }
