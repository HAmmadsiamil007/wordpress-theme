...
class Opulentia_Maintenance_Mode {
    ...
    public function customize_register( $wp_customize ) {
        $wp_customize->add_panel( 'opulentia_maintenance', array(
        ...
        // ── General ──
        $wp_customize->add_section( 'op_maintenance_general', array(
            'title' => __( 'General', 'opulentia' ),
            'panel' => 'opulentia_maintenance',
        ) );

        $wp_customize->add_setting( 'op_maintenance_enable', array(
            'default'           => false,
            'sanitize_callback' => 'wp_validate_boolean',
            'transport'         => 'refresh',
        ) );

        $wp_customize->add_control( 'op_maintenance_enable', array(
            'label'   => __( 'Enable Maintenance Mode', 'opulentia' ),
            'section' => 'op_maintenance_general',
            'type'    => 'checkbox',
        ) );

        $wp_customize->add_setting( 'op_maintenance_mode_type', array(
            'default'           => 'maintenance',
            'sanitize_callback' => 'sanitize_text_field',
            'transport'         => 'refresh',
        ) );

        $wp_customize->add_control( 'op_maintenance_mode_type', array(
        ...
        $wp_customize->add_setting( 'op_maintenance_heading', array(
            'default'           => __( 'We\'ll Be Back Soon', 'opulentia' ),
            'sanitize_callback' => 'sanitize_text_field',
            'transport'         => 'refresh',
        ) );

        $wp_customize->add_control( 'op_maintenance_heading', array(
            'label'   => __( 'Heading', 'opulentia' ),
            'section' => 'op_maintenance_general',
            'type'    => 'text',
        ) );

        $wp_customize->add_setting( 'op_maintenance_description', array(
            'default'           => __( 'Our site is currently undergoing scheduled maintenance. We appreciate your patience.', 'opulentia' ),
            'sanitize_callback' => 'wp_kses_post',
            'transport'         => 'refresh',
        ) );

        $wp_customize->add_control( 'op_maintenance_description', array(
        ...
        // ── Logo ──
        $wp_customize->add_section( 'op_maintenance_logo', array(
            'title' => __( 'Logo', 'opulentia' ),
            'panel' => 'opulentia_maintenance',
        ) );

        $wp_customize->add_setting( 'op_maintenance_logo', array(
            'default'           => '',
            'sanitize_callback' => 'esc_url_raw',
            'transport'         => 'refresh',
        ) );

        $wp_customize->add_control( new WP_Customize_Image_Control( $wp_customize, 'op_maintenance_logo', array(
            'label'   => __( 'Custom Logo', 'opulentia' ),
            'section' => 'op_maintenance_logo',
        ) ) );

        // ── Countdown ──
        $wp_customize->add_section( 'op_maintenance_countdown', array(
            'title' => __( 'Countdown Timer', 'opulentia' ),
            'panel' => 'opulentia_maintenance',
        ) );

        $wp_customize->add_setting( 'op_maintenance_countdown_enable', array(
            'default'           => false,
            'sanitize_callback' => 'wp_validate_boolean',
            'transport'         => 'refresh',
        ) );

        $wp_customize->add_control( 'op_maintenance_countdown_enable', array(
            'label'   => __( 'Enable Countdown', 'opulentia' ),
            'section' => 'op_maintenance_countdown',
            'type'    => 'checkbox',
        ) );

        $wp_customize->add_setting( 'op_maintenance_countdown_date', array(
            'default'           => '',
            'sanitize_callback' => 'sanitize_text_field',
            'transport'         => 'refresh',
        ) );

        $wp_customize->add_control( 'op_maintenance_countdown_date', array(
        ...
        // ── Social ──
        $wp_customize->add_section( 'op_maintenance_social', array(
            'title' => __( 'Social Links', 'opulentia' ),
            'panel' => 'opulentia_maintenance',
        ) );

        foreach ( array( 'facebook', 'twitter', 'instagram', 'linkedin', 'youtube' ) as $social ) {
            $wp_customize->add_setting( 'op_maintenance_social_' . $social, array(
                'default'           => '',
                'sanitize_callback' => 'esc_url_raw',
                'transport'         => 'refresh',
            ) );

            $wp_customize->add_control( 'op_maintenance_social_' . $social, array(
        ...
        // ── Subscribe ──
        $wp_customize->add_section( 'op_maintenance_subscribe', array(
            'title' => __( 'Subscribe Form', 'opulentia' ),
            'panel' => 'opulentia_maintenance',
        ) );

        $wp_customize->add_setting( 'op_maintenance_subscribe_enable', array(
            'default'           => false,
            'sanitize_callback' => 'wp_validate_boolean',
            'transport'         => 'refresh',
        ) );

        $wp_customize->add_control( 'op_maintenance_subscribe_enable', array(
            'label'   => __( 'Enable Subscribe Form', 'opulentia' ),
            'section' => 'op_maintenance_subscribe',
            'type'    => 'checkbox',
        ) );

        $wp_customize->add_setting( 'op_maintenance_subscribe_placeholder', array(
            'default'           => __( 'Enter your email', 'opulentia' ),
            'sanitize_callback' => 'sanitize_text_field',
            'transport'         => 'refresh',
        ) );

        $wp_customize->add_control( 'op_maintenance_subscribe_placeholder', array(
        ...
        // ── Background ──
        $wp_customize->add_section( 'op_maintenance_background', array(
            'title' => __( 'Background', 'opulentia' ),
            'panel' => 'opulentia_maintenance',
        ) );

        $wp_customize->add_setting( 'op_maintenance_bg_type', array(
            'default'           => 'color',
            'sanitize_callback' => 'sanitize_text_field',
            'transport'         => 'refresh',
        ) );

        $wp_customize->add_control( 'op_maintenance_bg_type', array(
        ...
        $wp_customize->add_setting( 'op_maintenance_bg_color', array(
            'default'           => '#1a1a1a',
            'sanitize_callback' => 'sanitize_hex_color',
            'transport'         => 'refresh',
        ) );

        $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'op_maintenance_bg_color', array(
            'label'   => __( 'Background Color', 'opulentia' ),
            'section' => 'op_maintenance_background',
        ) ) );

        $wp_customize->add_setting( 'op_maintenance_bg_gradient', array(
            'default'           => 'linear-gradient(135deg, #1a1a1a 0%, #333 100%)',
            'sanitize_callback' => 'sanitize_text_field',
            'transport'         => 'refresh',
        ) );

        $wp_customize->add_control( 'op_maintenance_bg_gradient', array(
            'label'   => __( 'Gradient CSS', 'opulentia' ),
            'section' => 'op_maintenance_background',
            'type'    => 'text',
        ) );

        $wp_customize->add_setting( 'op_maintenance_bg_image', array(
            'default'           => '',
            'sanitize_callback' => 'esc_url_raw',
            'transport'         => 'refresh',
        ) );

        $wp_customize->add_control( new WP_Customize_Image_Control( $wp_customize, 'op_maintenance_bg_image', array(
            'label'   => __( 'Background Image', 'opulentia' ),
            'section' => 'op_maintenance_background',
        ) ) );

        // ── Bypass ──
        $wp_customize->add_section( 'op_maintenance_bypass', array(
            'title' => __( 'Bypass Rules', 'opulentia' ),
            'panel' => 'opulentia_maintenance',
        ) );

        $wp_customize->add_setting( 'op_maintenance_bypass_users', array(
            'default'           => true,
            'sanitize_callback' => 'wp_validate_boolean',
            'transport'         => 'refresh',
        ) );

        $wp_customize->add_control( 'op_maintenance_bypass_users', array(
            'label'   => __( 'Allow Logged-In Users', 'opulentia' ),
            'section' => 'op_maintenance_bypass',
            'type'    => 'checkbox',
        ) );

        $wp_customize->add_setting( 'op_maintenance_bypass_ips', array(
            'default'           => '',
            'sanitize_callback' => 'sanitize_text_field',
            'transport'         => 'refresh',
        ) );

        $wp_customize->add_control( 'op_maintenance_bypass_ips', array(
        ...
        <body>
            <div class="op-mt__inner">
                ...
                foreach ( $socials as $s ) {
                    if ( get_theme_mod( 'op_maintenance_social_' . $s ) ) { $has_social = true; break; }
                }
                if ( $has_social ) : ?>
                <div class="op-mt__social">
                    <?php foreach ( $socials as $s ) : $url = get_theme_mod( 'op_maintenance_social_' . $s ); if ( $url ) : ?>
