...
class Opulentia_Wishlist_Compare {
    ...
    public function ajax_wishlist_toggle() {
        ...
        wp_send_json_success( array( 'active' => ! $active, 'count' => count( $wishlist ) ) );
    }
    ...
    public function ajax_compare_toggle() {
        ...
        wp_send_json_success( array( 'active' => ! $active, 'count' => count( $compare ) ) );
    }
            ...
            <table class="op-compare-table shop_table">
                <tbody>
                    <tr class="op-compare-row-image">
                        ...
                        <?php foreach ( $ids as $pid ) : $product = wc_get_product( $pid ); ?>
    ...
    public function register_customizer( $wp_customize ) {
        $wp_customize->add_section( 'opulentia_wishlist_compare', array(
            'title'    => __( 'Wishlist & Compare', 'opulentia' ),
            'panel'    => 'Opulentia_woocommerce',
            'priority' => 35,
        ) );

        $wp_customize->add_setting( 'wishlist-enable', array(
            'default'           => true,
            'sanitize_callback' => 'wp_validate_boolean',
            'transport'         => 'refresh',
        ) );
        $wp_customize->add_control( 'wishlist-enable', array(
            'label'   => __( 'Enable Wishlist', 'opulentia' ),
            'section' => 'opulentia_wishlist_compare',
            'type'    => 'checkbox',
        ) );

        $wp_customize->add_setting( 'compare-enable', array(
            'default'           => true,
            'sanitize_callback' => 'wp_validate_boolean',
            'transport'         => 'refresh',
        ) );
        $wp_customize->add_control( 'compare-enable', array(
            'label'   => __( 'Enable Compare', 'opulentia' ),
            'section' => 'opulentia_wishlist_compare',
            'type'    => 'checkbox',
        ) );

        $wp_customize->add_setting( 'wishlist-button-position', array(
            'default'           => 'after_add_to_cart',
            'sanitize_callback' => 'sanitize_text_field',
            'transport'         => 'refresh',
        ) );
        $wp_customize->add_control( 'wishlist-button-position', array(
        ...
        $wp_customize->add_setting( 'wishlist-icon-style', array(
            'default'           => 'heart',
            'sanitize_callback' => 'sanitize_text_field',
            'transport'         => 'refresh',
        ) );
        $wp_customize->add_control( 'wishlist-icon-style', array(
        ...
        $wp_customize->add_setting( 'compare-max-products', array(
            'default'           => 4,
            'sanitize_callback' => 'absint',
            'transport'         => 'refresh',
        ) );
        $wp_customize->add_control( 'compare-max-products', array(
