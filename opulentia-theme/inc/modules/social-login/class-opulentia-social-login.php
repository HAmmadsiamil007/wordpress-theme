...
class Opulentia_Social_Login {
	...
	public function register_customizer( $wp_customize ) {
		...
		$wp_customize->add_setting(
			'social-login-google-client-secret',
			array(
				'default'           => '',
				'sanitize_callback' => 'sanitize_text_field',
				'transport'         => 'refresh',
