...
class Opulentia_Custom_404 {
    ...
    public function register_customizer( $wp_customize ) {
        $wp_customize->add_section( 'opulentia_custom_404', array(
            'title'    => __( 'Custom 404 Page', 'opulentia' ),
            'panel'    => 'Opulentia_global_settings',
            'priority' => 100,
        ) );

        $wp_customize->add_setting( 'custom-404-enable', array(
            'default'           => true,
            'sanitize_callback' => 'wp_validate_boolean',
            'transport'         => 'refresh',
        ) );
        $wp_customize->add_control( 'custom-404-enable', array(
            'label'       => __( 'Enable Custom 404 Page', 'opulentia' ),
            'section'     => 'opulentia_custom_404',
            'type'        => 'checkbox',
        ) );

        $wp_customize->add_setting( 'custom-404-layout', array(
            'default'           => 'centered',
            'sanitize_callback' => 'sanitize_text_field',
            'transport'         => 'refresh',
        ) );
        $wp_customize->add_control( 'custom-404-layout', array(
        ...
        $wp_customize->add_setting( 'custom-404-title', array(
            'default'           => __( '404', 'opulentia' ),
            'sanitize_callback' => 'sanitize_text_field',
            'transport'         => 'postMessage',
        ) );
        $wp_customize->add_control( 'custom-404-title', array(
            'label'       => __( 'Title', 'opulentia' ),
            'section'     => 'opulentia_custom_404',
            'type'        => 'text',
        ) );

        $wp_customize->add_setting( 'custom-404-subtitle', array(
            'default'           => __( 'Page Not Found', 'opulentia' ),
            'sanitize_callback' => 'sanitize_text_field',
            'transport'         => 'postMessage',
        ) );
        $wp_customize->add_control( 'custom-404-subtitle', array(
            'label'       => __( 'Subtitle', 'opulentia' ),
            'section'     => 'opulentia_custom_404',
            'type'        => 'text',
        ) );

        $wp_customize->add_setting( 'custom-404-message', array(
        ...
        $wp_customize->add_control( 'custom-404-message', array(
            'label'       => __( 'Description Text', 'opulentia' ),
            'section'     => 'opulentia_custom_404',
            'type'        => 'textarea',
        ) );

        $wp_customize->add_setting( 'custom-404-image', array(
            'default'           => '',
            'sanitize_callback' => 'esc_url_raw',
            'transport'         => 'refresh',
        ) );
        $wp_customize->add_control( new WP_Customize_Image_Control( $wp_customize, 'custom-404-image', array(
            'label'       => __( '404 Illustration / Image', 'opulentia' ),
            'section'     => 'opulentia_custom_404',
        ) ) );

        $wp_customize->add_setting( 'custom-404-icon', array(
            'default'           => '',
            'sanitize_callback' => 'sanitize_text_field',
            'transport'         => 'refresh',
        ) );
        $wp_customize->add_control( 'custom-404-icon', array(
        ...
        $wp_customize->add_setting( 'custom-404-bg-color', array(
            'default'           => 'var(--color-primary-dark)',
            'sanitize_callback' => 'sanitize_text_field',
            'transport'         => 'postMessage',
        ) );
        $wp_customize->add_control( 'custom-404-bg-color', array(
        ...
        $wp_customize->add_setting( 'custom-404-bg-image', array(
            'default'           => '',
            'sanitize_callback' => 'esc_url_raw',
            'transport'         => 'refresh',
        ) );
        $wp_customize->add_control( new WP_Customize_Image_Control( $wp_customize, 'custom-404-bg-image', array(
            'label'       => __( 'Background Image', 'opulentia' ),
            'section'     => 'opulentia_custom_404',
        ) ) );

        $wp_customize->add_setting( 'custom-404-title-color', array(
            'default'           => 'var(--color-gold)',
            'sanitize_callback' => 'sanitize_text_field',
            'transport'         => 'postMessage',
        ) );
        $wp_customize->add_control( 'custom-404-title-color', array(
        ...
        $wp_customize->add_setting( 'custom-404-show-search', array(
            'default'           => true,
            'sanitize_callback' => 'wp_validate_boolean',
            'transport'         => 'refresh',
        ) );
        $wp_customize->add_control( 'custom-404-show-search', array(
            'label'       => __( 'Show Search Form', 'opulentia' ),
            'section'     => 'opulentia_custom_404',
            'type'        => 'checkbox',
        ) );

        $wp_customize->add_setting( 'custom-404-show-recent-posts', array(
            'default'           => true,
            'sanitize_callback' => 'wp_validate_boolean',
            'transport'         => 'refresh',
        ) );
        $wp_customize->add_control( 'custom-404-show-recent-posts', array(
            'label'       => __( 'Show Recent Posts', 'opulentia' ),
            'section'     => 'opulentia_custom_404',
            'type'        => 'checkbox',
        ) );

        $wp_customize->add_setting( 'custom-404-show-popular-pages', array(
            'default'           => true,
            'sanitize_callback' => 'wp_validate_boolean',
            'transport'         => 'refresh',
        ) );
        $wp_customize->add_control( 'custom-404-show-popular-pages', array(
            'label'       => __( 'Show Popular Page Links', 'opulentia' ),
            'section'     => 'opulentia_custom_404',
            'type'        => 'checkbox',
        ) );

        $wp_customize->add_setting( 'custom-404-cta-text', array(
            'default'           => __( 'Back to Homepage', 'opulentia' ),
            'sanitize_callback' => 'sanitize_text_field',
            'transport'         => 'postMessage',
        ) );
        $wp_customize->add_control( 'custom-404-cta-text', array(
            'label'       => __( 'CTA Button Text', 'opulentia' ),
            'section'     => 'opulentia_custom_404',
            'type'        => 'text',
        ) );

        $wp_customize->add_setting( 'custom-404-cta-url', array(
            'default'           => home_url( '/' ),
            'sanitize_callback' => 'esc_url_raw',
            'transport'         => 'refresh',
        ) );
        $wp_customize->add_control( 'custom-404-cta-url', array(
