...
class Opulentia_White_Label {
	...
	public function register_settings() {
		...
		register_setting(
			'general',
			'op_white_label_hide_theme_page',
			array(
				'type'    => 'boolean',
				'default' => false,
			)
		...
		add_settings_field(
			'op_white_label_brand_uri',
			__( 'Brand URI', 'opulentia' ),
			array( $this, 'render_field_text' ),
			'general',
			'op_white_label',
			array(
				'id'   => 'op_white_label_brand_uri',
				'type' => 'url',
			)
		);
		...
		add_settings_field(
			'op_white_label_dashboard_icon',
			__( 'Dashboard Icon URL', 'opulentia' ),
			array( $this, 'render_field_text' ),
			'general',
			'op_white_label',
			array(
				'id'   => 'op_white_label_dashboard_icon',
				'type' => 'url',
			)
		);
