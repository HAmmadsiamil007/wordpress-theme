...
class Opulentia_Spacing {
    ...
    public function register_customizer_section( $wp_customize ) {
        $wp_customize->add_section( 'opulentia_spacing', array(
        ...
        $this->add_responsive_control( $wp_customize, 'spacing_container_padding_top', array(
        ...
        $this->add_responsive_control( $wp_customize, 'spacing_container_padding_bottom', array(
        ...
        $this->add_responsive_control( $wp_customize, 'spacing_section_padding_top', array(
        ...
        $this->add_responsive_control( $wp_customize, 'spacing_section_padding_bottom', array(
        ...
        $this->add_responsive_control( $wp_customize, 'spacing_blog_gap', array(
        ...
        $wp_customize->add_setting( 'spacing_widget_margin_bottom', array(
            'default'           => 32,
            'sanitize_callback' => 'absint',
            'transport'         => 'postMessage',
        ) );
        $wp_customize->add_control( 'spacing_widget_margin_bottom', array(
        ...
        $this->add_responsive_control( $wp_customize, 'spacing_header_padding_top', array(
        ...
        $this->add_responsive_control( $wp_customize, 'spacing_header_padding_bottom', array(
        ...
        $this->add_responsive_control( $wp_customize, 'spacing_footer_padding_top', array(
        ...
        $this->add_responsive_control( $wp_customize, 'spacing_footer_padding_bottom', array(
    ...
    private function add_responsive_control( $wp_customize, $id, $args, $desktop = 0, $tablet = 0, $mobile = 0 ) {
        ...
        $wp_customize->add_control( new Opulentia_Responsive_Spacing_Control(
            $wp_customize,
            $id . '_ctrl',
            array(
                'label'       => $args['label'],
