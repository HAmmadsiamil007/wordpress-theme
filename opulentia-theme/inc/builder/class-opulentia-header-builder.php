...
class Opulentia_Header_Builder {
	...
	private static function get_row_components( $row ) {
		...
		$defaults   = array(
			'above' => array( 'top-bar-left', 'top-bar-right' ),
			'below' => array(),
		);
	...
	private static function render_component( $component, $layout ) {
		switch ( $component ) {
			case 'logo':
				...
				break;
			case 'primary-menu':
				self::render_primary_menu();
				break;
			case 'search':
				self::render_action_search();
				break;
			case 'account':
				self::render_action_account();
				break;
			case 'cart':
				self::render_action_cart();
				break;
			case 'wishlist':
				self::render_action_wishlist();
				break;
			case 'mobile-toggle':
				self::render_mobile_toggle();
				break;
			case 'custom-button':
			...
			case 'social-icons':
				...
				break;
			case 'top-bar-left':
				self::render_top_bar_left();
				break;
			case 'top-bar-right':
				self::render_top_bar_right();
				break;
		}
	}
