    ...
    private static function get_column_fallbacks() {
        return array(
            2 => array(
                ...
                'links' => array(
                    array( 'text' => __( 'Home', 'opulentia' ), 'url' => home_url( '/' ) ),
                    array( 'text' => __( 'Collection', 'opulentia' ), 'url' => home_url( '/collection' ) ),
                    array( 'text' => __( 'About Us', 'opulentia' ), 'url' => home_url( '/about-us' ) ),
                    array( 'text' => __( 'Craftsmanship', 'opulentia' ), 'url' => home_url( '/craftsmanship' ) ),
                    array( 'text' => __( 'Contact', 'opulentia' ), 'url' => home_url( '/contact' ) ),
                ),
            ),
            3 => array(
                'title' => __( 'Customer Service', 'opulentia' ),
                'links' => array(
                    array( 'text' => __( 'Shipping & Delivery', 'opulentia' ), 'url' => '#' ),
                    array( 'text' => __( 'Returns & Exchanges', 'opulentia' ), 'url' => '#' ),
                    array( 'text' => __( 'Size Guide', 'opulentia' ), 'url' => '#' ),
                    array( 'text' => __( 'FAQs', 'opulentia' ), 'url' => '#' ),
                    array( 'text' => __( 'Contact Us', 'opulentia' ), 'url' => '#' ),
                ),
            ),
            4 => array(
