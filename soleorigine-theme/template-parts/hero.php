...
$hero_title = get_theme_mod( 'hero_title', __( 'SoleOrigine', 'soleorigine' ) );
$hero_subtitle = get_theme_mod( 'hero_subtitle', __( 'Premium Italian Footwear', 'soleorigine' ) );
$hero_button_1_text = get_theme_mod( 'hero_button_1_text', __( 'Explore Collection', 'soleorigine' ) );
$hero_button_1_url = get_theme_mod( 'hero_button_1_url', '/collection' );
$hero_button_2_text = get_theme_mod( 'hero_button_2_text', __( 'View Styles', 'soleorigine' ) );
...
<section class="hero">
    ...
    <div class="hero__content">
        <div class="hero__logo">
            ...
            <span class="hero__logo-text">SOLEORIGINE</span>
