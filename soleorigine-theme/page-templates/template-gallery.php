...
<main id="primary" class="site-main">
    <section class="page-hero">
        <div class="container">
            ...
            <p class="page-hero__subtitle"><?php esc_html_e( 'Our Collections', 'soleorigine' ); ?></p>
        </div>
    </section>
    ...
    <section class="gallery-section">
        <div class="container">
            <div class="gallery-filters">
                <button class="gallery-filters__btn active" data-filter="all"><?php esc_html_e( 'All', 'soleorigine' ); ?></button>
                <button class="gallery-filters__btn" data-filter="classics"><?php esc_html_e( 'Classics', 'soleorigine' ); ?></button>
                <button class="gallery-filters__btn" data-filter="modern"><?php esc_html_e( 'Modern', 'soleorigine' ); ?></button>
                <button class="gallery-filters__btn" data-filter="limited"><?php esc_html_e( 'Limited Edition', 'soleorigine' ); ?></button>
            </div>
                ...
                ?>
                    <div class="gallery-item" data-category="<?php echo esc_attr( $item['category'] ); ?>">
                        ...
                        <div class="gallery-item__overlay">
                            ...
                            <a href="#" class="btn btn--small btn--outline"><?php esc_html_e( 'View Details', 'soleorigine' ); ?></a>
                        </div>
                    </div>
                <?php endforeach; ?>
            </div>
