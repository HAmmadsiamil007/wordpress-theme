...
<section class="hero" id="hero">
    ...
    <div class="hero__content">
        ...
        <div class="hero__scroll-indicator">
            <span><?php esc_html_e( 'SCROLL TO EXPLORE', 'soleorigine' ); ?></span>
        ...
        <div class="features-bar__grid">
            ...
            <div class="feature-item">
                ...
                <div class="feature-item__content">
                    ...
                    <p class="feature-item__text"><?php esc_html_e( 'Delivered to your doorstep anywhere.', 'soleorigine' ); ?></p>
                </div>
            </div>
        </div>
    </div>
...
<section class="elite-collection">
    <div class="container">
        <div class="section-header">
            <p class="section-subtitle"><?php esc_html_e( 'Exclusive Selection', 'soleorigine' ); ?></p>
            <div class="gold-line"></div>
            <h2 class="section-title"><?php esc_html_e( 'THE ELITE COLLECTION', 'soleorigine' ); ?></h2>
            <p class="section-description">
                <?php esc_html_e( 'Handpicked premium designs for the discerning gentleman who accepts nothing less than perfection.', 'soleorigine' ); ?>
            </p>
        </div>
        ...
        <div class="brand-story__grid">
            ...
            <div class="brand-story__content">
                ...
                <a href="<?php echo esc_url( home_url( '/about-us' ) ); ?>" class="btn btn--primary">
                    <?php esc_html_e( 'Discover Our Story', 'soleorigine' ); ?>
                </a>
            </div>
        </div>
    </div>
...
<section class="testimonials">
    <div class="container">
        <div class="section-header">
            <p class="section-subtitle"><?php esc_html_e( 'Client Stories', 'soleorigine' ); ?></p>
            <div class="gold-line"></div>
            <h2 class="section-title"><?php esc_html_e( 'WHAT OUR CLIENTS SAY', 'soleorigine' ); ?></h2>
        </div>
...
<section class="instagram-feed">
    <div class="container">
        <div class="section-header">
            <p class="section-subtitle"><?php esc_html_e( 'Follow Us', 'soleorigine' ); ?></p>
            <h2 class="section-title"><?php esc_html_e( '@SOLEORIGINE', 'soleorigine' ); ?></h2>
        </div>
