...
<div class="woocommerce-myaccount">
    <div class="page-header">
        <h1 class="page-header__title"><?php esc_html_e( 'My Account', 'soleorigine' ); ?></h1>
        <p class="page-header__subtitle"><?php esc_html_e( 'Manage your account settings', 'soleorigine' ); ?></p>
    </div>
        ...
        <div class="woocommerce-notices-wrapper">
            <div class="woocommerce-info">
                ...
                printf(
                    ...
                    esc_html__( 'Please %s to access your account.', 'soleorigine' ),
        ...
        <div class="woocommerce-row">
            <div class="woocommerce-col-half">
                <div class="woocommerce-form-login">
                    <h2><?php esc_html_e( 'Login', 'soleorigine' ); ?></h2>
            ...
            <div class="woocommerce-col-half">
                <div class="woocommerce-form-register">
                    <h2><?php esc_html_e( 'Register', 'soleorigine' ); ?></h2>
